    ...
    <div class="sidebar-inner" data-simplebar>
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li>
                    <ul>
                        <li class="submenu">
                            ...
                            <ul>
                                <li><a href="index-2.html" class="active">Deals Dashboard</a></li>
                ...
                <li>
                    <ul>
                        <li><a href="https://crms.dreamstechnologies.com/documentation/html.html"><i class="ti ti-file-stack"></i><span>Documentation</span></a></li>
                        <li><a href="https://crms.dreamstechnologies.com/documentation/changelog.html"><i class="ti ti-arrow-capsule"></i><span>Changelog v2.3.1</span></a></li>
                        <li class="submenu">
