            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <?php if (!empty($model->products)): ?>
                        <div class="mb-4">
                            <h6 class="mb-3 fs-16 fw-bold">Mahsulotlar (<?= count($model->products) ?> ta)</h6>
                                ...
                                <table class="table table-nowrap border">
                                    ...
                                    <?php foreach ($model->products as $index => $product): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?= $product->status == 1 ? '<span class="badge badge-outline-success">Faol</span>' : '<span class="badge badge-outline-danger">Nofaol</span>' ?>
                                            </td>
                                            <td>
                                                <?= Html::a('Ko\'rish', ['/product/view', 'id' => $product->id], ['class' => 'btn btn-sm btn-primary']) ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
