...
?>
    ...
    <div class="content">
        ...
        <h4 class="mb-4"><?= $model->isNewRecord ? 'Yangi mahsulot qo\'shish' : 'Mahsulotni tahrirlash' ?></h4>
            ...
            <div class="col-lg-10 mx-auto">
                ...
                <div class="card mb-0">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Kategoriya<span class="text-danger ms-1">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="me-3">
                                            <input type="radio" name="Product[status]" value="1" id="status-active" <?= ($model->isNewRecord || $model->status == 1) ? 'checked' : '' ?>>
                                            <label for="status-active" class="ms-1">Faol</label>
                                        </div>
                                        <div>
                                            <input type="radio" name="Product[status]" value="0" id="status-inactive" <?= (!$model->isNewRecord && $model->status == 0) ? 'checked' : '' ?>>
...
$this->registerJs("
    ...
    $('.delete-image').click(function() {
        ...
        $.ajax({
            url: '/product/delete-image?id=' + id,
            type: 'POST',
            data: {
                imagePath: path,
