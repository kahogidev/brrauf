            ...
            <div class="col-lg-10 mx-auto">
                ...
                <div class="card mb-0">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Kontent (O'zbekcha)<span class="text-danger ms-1">*</span></label>
                            <?= $form->field($model, 'content_uz')->textarea(['rows' => 8, 'class' => 'form-control'])->label(false) ?>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Kontent (Ruscha)<span class="text-danger ms-1">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="me-3">
                                            <input type="radio" name="AboutCompany[status]" value="1" id="status-active" <?= ($model->isNewRecord || $model->status == 1) ? 'checked' : '' ?>>
                                            <label for="status-active" class="ms-1">Faol</label>
                                        </div>
                                        <div>
                                            <input type="radio" name="AboutCompany[status]" value="0" id="status-inactive" <?= (!$model->isNewRecord && $model->status == 0) ? 'checked' : '' ?>>
...
$this->registerJs("
    ...
    $('.delete-image').click(function() {
        ...
        $.ajax({
            url: '/about-company/delete-image?id=' + id,
            type: 'POST',
            data: {
                imagePath: path,
