...
$this->title = $model->title_uz . ' (' . $model->year . ')';
?>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between border-1 border-bottom pb-3 mb-3">
                        <div>
                            ...
                            <span class="badge bg-primary-subtle text-primary-emphasis"><?= $model->year ?></span>
                        </div>
                        <div>
                    ...
                    <div class="row pb-3 mb-3 border-1 border-bottom">
                        <div class="col-lg-6">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <h6 class="fs-14 fw-medium text-body">Yil:</h6>
                                <h6 class="fs-14 fw-semibold text-dark"><?= $model->year ?></h6>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                    ...
                    <div class="text-center d-flex align-items-center justify-content-center gap-2">
                        ...
                        <?= Html::a('<i class="ti ti-trash me-1"></i>O\'chirish', ['delete', 'id' => $model->id], [
                            ...
                            'data' => [
                                'confirm' => 'Rostdan ham bu tarixni o\'chirmoqchimisiz?',
                                'method' => 'post',
                            ],
                        ]) ?>
                    </div>
