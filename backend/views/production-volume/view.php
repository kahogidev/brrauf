                ...
                <div class="card-body">
                    ...
                    <div class="row pb-3 border-1 border-bottom mb-4">
                        <div class="col-lg-6">
                            ...
                            <?php endif; ?>
                            <div class="mb-3">
                                <p class="text-body mb-1">Hajm:</p>
                                <p class="text-dark fw-bold fs-18 text-primary">
                                    <?= number_format($model->volume, 2) ?> <?= Html::encode($model->unit_uz) ?>
                                </p>
                            </div>
                            <?php if ($model->period_uz): ?>
                                <div class="mb-3">
                                    <p class="text-body mb-1">Davr:</p>
                                    <p class="text-dark"><?= Html::encode($model->period_uz) ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <?php endif; ?>
                            <div class="mb-3">
                                <p class="text-body mb-1">Объем:</p>
                                <p class="text-dark fw-bold fs-18 text-primary">
                                    <?= number_format($model->volume, 2) ?> <?= Html::encode($model->unit_ru) ?>
                                </p>
                            </div>
                            <?php if ($model->period_ru): ?>
                                <div class="mb-3">
                                    <p class="text-body mb-1">Период:</p>
                                    <p class="text-dark"><?= Html::encode($model->period_ru) ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="text-center d-flex align-items-center justify-content-center gap-2">
                        ...
                        <?= Html::a('<i class="ti ti-trash me-1"></i>O\'chirish', ['delete', 'id' => $model->id], [
                            ...
                            'data' => [
                                'confirm' => 'Rostdan ham bu ma\'lumotni o\'chirmoqchimisiz?',
                                'method' => 'post',
                            ],
                        ]) ?>
                    </div>
