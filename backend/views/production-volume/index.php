...
$this->title = 'Ishlab chiqarish hajmi';
?>
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Ishlab chiqarish hajmi ro'yxati</h4>
                </div>
                <div class="card-body">
                            ...
                            <?php if ($dataProvider->getModels()): ?>
                                <?php foreach ($dataProvider->getModels() as $index => $model): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <span class="fw-bold text-primary"><?= number_format($model->volume, 2) ?></span>
                                                <small class="text-muted d-block"><?= Html::encode($model->unit_uz) ?></small>
                                            </div>
                                        </td>
                                        <td>
                                            <?php if ($model->period_uz): ?>
                                                <span class="badge bg-info-subtle text-info-emphasis">
                                                        <?= Html::encode($model->period_uz) ?>
                                                    </span>
                                            <?php else: ?>
