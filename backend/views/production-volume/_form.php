...
/* @var $model app\models\ProductionVolume */
/* @var $form yii\widgets\ActiveForm */
?>

    <div class="content">

        <h4 class="mb-4"><?= $model->isNewRecord ? 'Yangi hajm qo\'shish' : 'Hajmni tahrirlash' ?></h4>
            ...
            <div class="col-lg-10 mx-auto">
                ...
                <div class="card mb-0">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Qisqacha tavsif (O'zbekcha)</label>
                            <?= $form->field($model, 'description_uz')->textarea(['rows' => 3, 'class' => 'form-control'])->label(false) ?>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Qisqacha tavsif (Ruscha)</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Hajm (miqdor)<span class="text-danger ms-1">*</span></label>
                                    <?= $form->field($model, 'volume')->textInput(['type' => 'number', 'step' => '0.01', 'min' => 0, 'class' => 'form-control'])->label(false) ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">O'lchov birligi (O'zbekcha)<span class="text-danger ms-1">*</span></label>
                                    <?= $form->field($model, 'unit_uz')->textInput(['maxlength' => true, 'class' => 'form-control', 'placeholder' => 'dona, kg, m³, va h.k.'])->label(false) ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">O'lchov birligi (Ruscha)<span class="text-danger ms-1">*</span></label>
                                    <?= $form->field($model, 'unit_ru')->textInput(['maxlength' => true, 'class' => 'form-control', 'placeholder' => 'шт, кг, м³, и т.д.'])->label(false) ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Davr (O'zbekcha)</label>
                                    <?= $form->field($model, 'period_uz')->textInput(['maxlength' => true, 'class' => 'form-control', 'placeholder' => 'oylik, yillik, va h.k.'])->label(false) ?>
                                </div>
                            </div>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Davr (Ruscha)</label>
                            <?= $form->field($model, 'period_ru')->textInput(['maxlength' => true, 'class' => 'form-control', 'placeholder' => 'месячный, годовой, и т.д.'])->label(false) ?>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="me-3">
                                            <input type="radio" name="ProductionVolume[status]" value="1" id="status-active" <?= ($model->isNewRecord || $model->status == 1) ? 'checked' : '' ?>>
                                            <label for="status-active" class="ms-1">Faol</label>
                                        </div>
                                        <div>
                                            <input type="radio" name="ProductionVolume[status]" value="0" id="status-inactive" <?= (!$model->isNewRecord && $model->status == 0) ? 'checked' : '' ?>>
...
$this->registerJs("
    ...
    $('.delete-image').click(function() {
        ...
        $.ajax({
            url: '/production-volume/delete-image?id=' + id,
            type: 'POST',
            data: {
                imagePath: path,
