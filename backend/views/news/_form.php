            ...
            <div class="col-lg-10 mx-auto">
                ...
                <div class="card mb-0">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Kontent (O'zbekcha)</label>
                            <?= $form->field($model, 'content_uz')->textarea(['rows' => 8, 'class' => 'form-control'])->label(false) ?>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Kontent (Ruscha)</label>
                            <?= $form->field($model, 'content_ru')->textarea(['rows' => 8, 'class' => 'form-control'])->label(false) ?>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">E'lon sanasi</label>
                            <?= $form->field($model, 'published_date')->input('date', ['class' => 'form-control'])->label(false) ?>
                        </div>
                            ...
                            <div id="video-links-container">
                                ...
                                foreach ($videos as $index => $video):
                                    ...
                                    <div class="input-group mb-2 video-link-item">
                                        <input type="text" name="video_links[]" class="form-control" value="<?= Html::encode($video) ?>" placeholder="https://www.youtube.com/watch?v=...">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="me-3">
                                            <input type="radio" name="News[status]" value="1" id="status-active" <?= ($model->isNewRecord || $model->status == 1) ? 'checked' : '' ?>>
                                            <label for="status-active" class="ms-1">Faol</label>
                                        </div>
                                        <div>
                                            <input type="radio" name="News[status]" value="0" id="status-inactive" <?= (!$model->isNewRecord && $model->status == 0) ? 'checked' : '' ?>>
...
$this->registerJs("
    ...
    $('#add-video-link').click(function() {
        var html = '<div class=\"input-group mb-2 video-link-item\">' +
            '<input type=\"text\" name=\"video_links[]\" class=\"form-control\" placeholder=\"https://www.youtube.com/watch?v=...\">' +
