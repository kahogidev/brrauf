...
(function($) {
	...
	//service-carousel Three
	if ($('.service-three-slider-home7').length) {
		var swiper = new Swiper(".service-three-slider-home7", {
			slidesPerView: 1,
			spaceBetween: 30,
			navigation: {
	            nextEl: '.swiper-button-next',
	...
	//service-carousel Three home9
	if ($('.service-three-slider-home9').length) {
		var swiper = new Swiper(".service-three-slider-home9", {
			slidesPerView: 1,
			spaceBetween: 30,
			navigation: {
          nextEl: '.service-three9-next',
          prevEl: '.service-three9-prev',
      },
			breakpoints: {
				320: {
					slidesPerView: 1,
